...
### [SPRINT 9] Holistic 4-Pillar Daily Quests System

#### 🔷 PBI-020: Holistic 4-Pillar Daily Quests System (Fitness, Learning, Physical Health, Mindfulness)
* **Status:** 🟢 **DONE**
* **Priority:** Highest (P0)
* **Estimation:** 5 Story Points
* **User Story:**
  > ในฐานะ **ผู้ใช้งานที่ต้องการสร้างวินัยและพัฒนาตนเองรอบด้านอย่างสมดุล**  
  > ฉันต้องการ **ให้เควสต์ประจำวันครอบคลุม 4 เสาหลักของชีวิต: การออกกำลังกาย (Fitness), การพัฒนาตนเองและหาความรู้ (Learning), สุขภาพกายและการดูแลตัวเอง (Physical Health & Self-Care), และสุขภาพใจและสมาธิ (Mindfulness) พร้อมแท็บคัดกรองหมวดหมู่และตัวนับสถานะแบบเรียลไทม์**  
  > เพื่อที่ **ฉันจะได้มีชีวิตที่ก้าวหน้า มีสุขภาพร่างกายที่แข็งแรง และจิตใจที่สงบผ่อนคลายในทุกๆ วันอย่างมีความสุข**
* **Acceptance Criteria (DoD):**
  - [x] ออกแบบโครงสร้างประเภทข้อมูล `QuestCategory = 'fitness' | 'learning' | 'health' | 'mind'` ใน `src/types/index.ts`
  - [x] อัปเดตคลังเควสต์ประจำวันรวม 20 เควสต์ ครอบคลุม 4 เสาหลักอย่างลงตัว:
    - 🏃 **การออกกำลังกาย & บอดี้เวท (Fitness - 5 เควสต์):** วิดพื้นในห้อง 30 ครั้ง (20c), สควอท/ลันจ์ 50 ครั้ง (25c), เดินสะสม 6,000 ก้าว (30c), ยืดเหยียดคลายกล้ามเนื้อ 15 นาที (20c), ฮิตเบิร์นไขมัน 15 นาที (35c)
    - 🧠 **พัฒนาตัวเอง & การเรียนรู้ (Learning & Growth - 5 เควสต์):** อ่านหนังสือพัฒนาตนเอง 10-15 หน้า (25c), ฟังพอดแคสต์/สรุปหนังสือ 1 ตอน (20c), ทำ Deep Work / เขียนโค้ด / ฝึกสกิล 25 นาที (30c), จดสรุปสิ่งที่ได้เรียนรู้วันนี้ 1 เรื่อง (20c), ทบทวนและวางแผน 3 งานสำคัญพรุ่งนี้ (20c)
    - 🥗 **สุขภาพกาย & การดูแลตัวเอง (Physical Health & Self-Care - 5 เควสต์):** ดื่มน้ำเปล่าบริสุทธิ์สะสมครบ 2.5 ลิตร (20c), พักสายตากฎ 20-20-20 ทุก 1-2 ชม. (15c), รับแดดยามเช้า 10-15 นาที (15c), กินอาหารมีประโยชน์/งบหวานจัด (25c), นอนหลับพักผ่อนเต็มอิ่ม 7-8 ชม. (35c), Self-Care วันพิเศษ: อาบน้ำใหญ่ ขัดผิว มาร์คหน้า ทาครีมครบเซ็ต (50c)
    - 🧘 **สุขภาพใจ & สมาธิ (Mindfulness & Mental Health - 5 เควสต์):** Digital Detox งดเล่นโซเชียล 30 นาทีก่อนนอน (20c), นั่งสมาธิ/ฝึกหายใจ 5-10 นาที (20c), จัดโต๊ะทำงานหรือห้องนอนให้สะอาด (25c), ขอบคุณ 3 สิ่งดีๆ ที่เกิดขึ้นในวันนี้ (20c), เขียน Emotional Journal ระบายและบันทึกอารมณ์ (30c)
  - [x] พัฒนาระบบแท็บตัวกรอง 4 เสาหลัก (Category Filter Bar) ด้านบนหน้ารายการเควสต์: `✨ ทั้งหมด`, `🏃 ออกกำลังกาย`, `🧠 พัฒนาตัวเอง`, `🥗 สุขภาพกาย`, `🧘 สุขภาพใจ` พร้อมแสดงตัวนับเควสต์ที่เสร็จแล้ว/ทั้งหมดของแต่ละหมวดแบบเรียลไทม์
  - [x] แสดงป้ายหมวดหมู่ (Category Badge) สีเฉพาะตัวบนการ์ดเควสต์ทุกใบ (`QuestCard.tsx`)
  - [x] รองรับการเลือกหมวดหมู่ตอนสร้างเควสต์ใหม่ (`QuestModal.tsx`) โดยผู้ใช้สามารถระบุหมวดหมู่ที่ต้องการได้อย่างง่ายดาย
  - [x] พัฒนาระบบ **Smart Merge** ใน Redux Hydration เพื่อนำเข้า 20 เควสต์ใหม่โดยไม่ทำให้สถานะเควสต์ที่ผู้ใช้เคยติ๊กแล้วหายไป และไม่กระทบเควสต์ที่ผู้ใช้สร้างเอง
